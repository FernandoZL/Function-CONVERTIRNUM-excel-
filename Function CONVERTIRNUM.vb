...
' Parámetros
'************************************************************
Moneda = ""         'Nombre de Moneda (Singular)
Monedas = ""       'Nombre de Moneda (Plural)
Centimo = ""     'Nombre de Céntimos (Singular)
Centimos = ""   'Nombre de Céntimos (Plural)
Preposicion = "Punto"     'Preposición entre Moneda y Céntimos
'************************************************************
